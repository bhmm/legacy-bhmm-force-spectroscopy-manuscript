...
{\color{blue}We solve this problem through a Bayesian extension that allows the experimental uncertainties to be directly quantified, and permits uncertainty to be further reduced through the imposition of physical priors (such as the requirement that dynamics obey detailed balance).}
...
\begin{figure*}[tb]
\noindent
\resizebox{0.8\textwidth}{!}{\includegraphics{algorithm-workflow/Fig_ProbabilitySpace.pdf}}
...
\resizebox{\textwidth}{!}{\includegraphics{synthetic-three-state-model-mlhmm}}
